...
public class LethalInjection : CustomItem
{
    ...
    /// <inheritdoc/>
    public override string Name { get; set; } = "Uus-LJ";
        ...
        Timing.CallDelayed(1.5f, () =>
        {
            ...
            foreach (Exiled.API.Features.Player player in Exiled.API.Features.Player.List)
            {
                if (player.Role == RoleTypeId.Scp096)
                {
                    ...
                    Log.Debug($"{player.Nickname} 096 component found." + scp096.RageState);
                    if ((scp096.RageState == Scp096RageState.Docile) || (scp096.RageState == Scp096RageState.Calming))
                        continue;
